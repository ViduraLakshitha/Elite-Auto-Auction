    ...
    <div className="bg-gradient-to-b from-gray-900 to-black text-white w-64 min-h-screen p-6 shadow-lg">
      ...
      <nav>
        <ul className="space-y-4">
          ...
          <li>
            <Link to="/admin/vehicles" className="flex items-center p-3 hover:bg-gradient-to-r hover:from-yellow-500 hover:to-yellow-600 rounded-lg transition duration-300">
