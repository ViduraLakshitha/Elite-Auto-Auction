...
const TransportationForm = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.registrationNumber.trim()) {
      ...
      !/^[A-Za-z0-9-]{5,20}$/.test(formData.registrationNumber.trim())
    ) {
      newErrors.registrationNumber =
        "Registration number must be 5-20 alphanumeric characters";
    }
    ...
    if (!formData.taxIdentificationNumber.trim()) {
      ...
      !/^[A-Za-z0-9-]{5,20}$/.test(formData.taxIdentificationNumber.trim())
    ) {
      newErrors.taxIdentificationNumber =
        "Tax ID must be 5-20 alphanumeric characters";
    }
    ...
    if (
      formData.state.trim() &&
      !/^[A-Za-z\s]{2,56}$/.test(formData.state.trim())
    ) {
    ...
    if (!formData.phoneNumber.trim()) {
      ...
      !/^[+]?[(]?[0-9]{1,4}[)]?[-\s.]?[0-9]{3}[-\s.]?[0-9]{4,7}$/.test(
    ...
    if (
      ...
      !/^(https?:\/\/)?(www\.)?([a-zA-Z0-9-]+\.){1,}[a-zA-Z]{2,}(\/[a-zA-Z0-9-._~:/?#[\]@!$&'()*+,;=]*)?$/.test(
        formData.website.trim()
      )
    ) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!token) {
      setErrors({
        general: "Please log in to register your transportation company",
      });
      setLoading(false);
      return;
    }
    ...
    try {
      await axios.post(
        "http://localhost:5555/api/transportation/register",
        formData,
        {
          headers: {
      ...
      setErrors({
        general:
          ...
          "Error registering transportation company. Please try again.",
      });
    } finally {
      setLoading(false);
    }
          ...
          <div className="bg-gradient-to-r from-yellow-900 via-black to-yellow-900 rounded-3xl shadow-2xl overflow-hidden border border-yellow-600">
            ...
            <div className="bg-gradient-to-r from-yellow-700 to-yellow-900 p-6 text-center border-b border-yellow-600">
              ...
              <p className="text-yellow-200 mt-2">
                Enter your transportation company details to join our exclusive
                network
              </p>
            </div>
            ...
            <div className="p-8 bg-black bg-opacity-70">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <input
                        ...
                        className={`block w-full pl-10 pr-3 py-2 rounded-lg border ${
                          errors.companyName
                            ? "border-red-500"
                            : "border-yellow-600"
                        } bg-black bg-opacity-70 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-yellow-600 focus:border-transparent`}
                  ...
                  <div className="form-group">
                    <label className="block text-yellow-400 text-sm font-medium mb-2">
                      <span className="text-yellow-400">*</span> Tax
                  ...
                  <div className="form-group">
                    ...
                    <input
                      type="text"
                      name="state"
                      className={`block w-full pl-3 pr-3 py-2 rounded-lg border ${
                        errors.state ? "border-red-500" : "border-yellow-600"
                      } bg-black bg-opacity-70 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-yellow-600 focus:border-transparent`}
                  ...
                  <div className="form-group">
                    ...
                    <input
                      ...
                      name="city"
                      className={`block w-full pl-3 pr-3 py-2 rounded-lg border ${
                        errors.city ? "border-red-500" : "border-yellow-600"
                      } bg-black bg-opacity-70 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-yellow-600 focus:border-transparent`}
                      value={formData.city}
                      onChange={handleChange}
                  ...
                  <div className="form-group md:col-span-2">
                    ...
                    <input
                      ...
                      name="website"
                      className={`block w-full pl-3 pr-3 py-2 rounded-lg border ${
                        errors.website ? "border-red-500" : "border-yellow-600"
                      } bg-black bg-opacity-70 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-yellow-600 focus:border-transparent`}
